...
class TestDataValidator:
    ...
    def test_validate_answer_vazia(self, mock_validator):
        """Testa validação de resposta vazia"""
        valido, erro = mock_validator.validate_answer({}, "teste")
    ...
    def test_validar_renda_valida(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "minha renda é 5000")
    ...
    def test_validar_renda_negativa(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "teste")
    ...
    def test_validar_perfil_conservador(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "sou conservador")
    ...
    def test_validar_perfil_moderado(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "sou moderado")
    ...
    def test_validar_perfil_arrojado(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "sou arrojado")
    ...
    def test_validar_perfil_invalido(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "sou agressivo")
    ...
    def test_validar_meta_valida(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "meta de comprar carro")
    ...
    def test_validar_idade_valida(self, mock_validator):
        ...
        dados = {"idade": 30}
        valido, erro = mock_validator.validate_answer(dados, "tenho 30 anos")
    ...
    def test_validar_idade_minima(self, mock_validator):
        ...
        dados = {"idade": 18}
        valido, erro = mock_validator.validate_answer(dados, "tenho 18 anos")
    ...
    def test_validar_idade_abaixo_minimo(self, mock_validator):
        ...
        dados = {"idade": 15}
        valido, erro = mock_validator.validate_answer(dados, "tenho 15 anos")
    ...
    def test_validar_idade_acima_maximo(self, mock_validator):
        ...
        dados = {"idade": 150}
        valido, erro = mock_validator.validate_answer(dados, "tenho 150 anos")
    ...
    def test_bloquear_termo_proibido_invista(self, mock_validator):
        ...
        valido, erro = mock_validator.validate_answer(dados, "invista em bitcoin")
    ...
    def test_bloquear_termo_proibido_compre(self, mock_validator):
        ...
        dados = {"renda_mensal": 5000}
        valido, erro = mock_validator.validate_answer(dados, "compre ações agora")
    ...
    def test_bloquear_termo_proibido_recomendo(self, mock_validator):
        ...
        dados = {"renda_mensal": 5000}
        valido, erro = mock_validator.validate_answer(dados, "recomendo esse investimento")
